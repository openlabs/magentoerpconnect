...
class product_product(magerp_osv.magerp_osv):
    ...
    def ext_export_configurable(self, cr, uid, id, external_referential_ids=None, defaults=None, context=None):
        ...
        logger.notifyChannel('ext synchro', netsvc.LOG_INFO, "Warning! exporting configurable product (id %s) requires manual settings on Magento side" %(id))
    ...
    def ext_product_assign(self, cr, uid, type, parent_id, child_ids, quantities=None, position=None, external_referential_ids=None, defaults=None, context=None):
        ...
        for external_referential_id in external_referential_ids:
            ...
            export_ctx['do_not_update_date'] = True
